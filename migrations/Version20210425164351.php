 ...
 */
final class Version20210425164351 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE poste (id INT AUTO_INCREMENT NOT NULL, habilitation_id INT DEFAULT NULL, service_id INT DEFAULT NULL, nom VARCHAR(50) NOT NULL, autorisation INT NOT NULL, INDEX IDX_7C890FAB389712CD (habilitation_id), INDEX IDX_7C890FABED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, poste_id INT DEFAULT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, identifiant VARCHAR(50) NOT NULL, mdp VARCHAR(50) NOT NULL, INDEX IDX_1D1C63B3A0905086 (poste_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE poste DROP FOREIGN KEY FK_7C890FAB389712CD');
        ...
        $this->addSql('ALTER TABLE poste DROP FOREIGN KEY FK_7C890FABED5CA9E6');
